...
const props = defineProps({
    color: {
        type: String,
        default: "#fd8b1d", // Standaard kleur is oranje, maar omdat de wave op meerdere plekken wordt gebruikt kan de kleur aangepast worden
    },
    svgClass: {
        type: String,
        default: "",
...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({ ...{ class: ((props.svgClass)) }, viewBox: ("0 0 3840 96"), preserveAspectRatio: ("none"), });
...
;
//# sourceMappingURL=wave-section.vue.js.map